...
const EXAMPLE_DATA: MembersTableItem[] = [
  {id: 1, name: '0x11938c900b6ec9397abb721c5bbff5ace46e0f50', shares:1, join_date:new Date('2021-01-01')},
  {id: 2, name: '0x28345c900b6ec9397abb721c5bbff5ace46e0f50', shares:1, join_date:new Date('2021-01-01')},
];
  ...
  private getSortedData(data: MembersTableItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        ...
        case 'shares': return compare(+a.shares, +b.shares, isAsc);
        case 'join_date': return compare(+a.join_date, +b.join_date, isAsc);        
        default: return 0;
      }
    });
  }
